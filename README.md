...
This project focuses on Hugo de Groot and Christiaan Huyghens, two prolific multilingual authors active in the Low Countries during the Dutch golden age, though active at separate times. By comparing them against other roughly contemporary Dutch scientists, we can see if their language use follows that of their peers and the time period.
